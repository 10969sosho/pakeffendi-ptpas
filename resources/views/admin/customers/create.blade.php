            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input name="full_name" value="{{ old('full_name') }}" required class="w-full rounded-lg border border-slate-200 focus:border-sky-500 focus:ring-sky-500">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input name="ktp_number" value="{{ old('ktp_number') }}" required class="w-full rounded-lg border border-slate-200 focus:border-sky-500 focus:ring-sky-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium mb-1">NPWP</label>
                        <input name="npwp" value="{{ old('npwp') }}" class="w-full rounded-lg border border-slate-200 focus:border-sky-500 focus:ring-sky-500">
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="md:col-span-2">
                        ...
                        <textarea name="address" rows="3" class="w-full rounded-lg border border-slate-200 focus:border-sky-500 focus:ring-sky-500">{{ old('address') }}</textarea>
                    </div>
                    <div>
                        <label class="block text-sm font-medium mb-1">Nama Provinsi</label>
                        <input name="province" value="{{ old('province') }}" class="w-full rounded-lg border border-slate-200 focus:border-sky-500 focus:ring-sky-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium mb-1">Nama Kota</label>
                        <input name="city" value="{{ old('city') }}" class="w-full rounded-lg border border-slate-200 focus:border-sky-500 focus:ring-sky-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium mb-1">Kode POS</label>
                        <input name="postal_code" value="{{ old('postal_code') }}" class="w-full rounded-lg border border-slate-200 focus:border-sky-500 focus:ring-sky-500">
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input name="phone" value="{{ old('phone') }}" required class="w-full rounded-lg border border-slate-200 focus:border-sky-500 focus:ring-sky-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium mb-1">Contact Person *</label>
                        <input name="contact_person" value="{{ old('contact_person') }}" required class="w-full rounded-lg border border-slate-200 focus:border-sky-500 focus:ring-sky-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium mb-1">Company Name</label>
                        <input name="company_name" value="{{ old('company_name') }}" class="w-full rounded-lg border border-slate-200 focus:border-sky-500 focus:ring-sky-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium mb-1">Internal Code</label>
                        <input name="internal_code" value="{{ old('internal_code') }}" class="w-full rounded-lg border border-slate-200 focus:border-sky-500 focus:ring-sky-500">
                    </div>
                    <div>
                        ...
                        <p class="text-xs text-slate-500 mt-1">Kosongkan jika customer mendaftar sendiri / tanpa sales.</p>
                    </div>
                </div>
            </div>
